...
namespace LPR381Solver
{
    public class KnapsackResult
    {
        ...
        public int NumEvaluationNodes { get; set; }
    }
    ...
    internal class Node
    {
        ...
        public static KnapsackResult solve(double[] c, double[,] A, double[] b)
        {
            ...
            while (stack.Count > 0)
            {
                ...
                rightChild.Bound = CalculateBound(rightChild, n, capacity, items);
        ...
        private static double CalculateBound(Node u, int n, double capacity, List<Item> items)
        {
